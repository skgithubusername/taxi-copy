...
export default function Blog2Content() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
            ...
            text: 'Discover budget-friendly taxi services in Himachal Pradesh! Find low-cost rides, shared cabs, and the best ways to explore the mountains affordably.   ',
  ...
  return (
    <div className="min-h-screen bg-teal-500 text-white">
      {/* Hero Section */}
      <div className="relative h-96 bg-cover bg-center" style={{ backgroundImage: "url('/api/placeholder/1200/400')" }}>
        <div className="absolute inset-0 bg-teal-500 bg-opacity-70 flex items-center justify-center">
          <div className="text-center px-4">
            <h1 className="text-4xl md:text-5xl font-bold  mb-4">Himachal Pradesh on a Shoestring</h1>
      ...
      <div className="bg-teal-900 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-teal-100 mb-12">Why Choose Our Low-Cost Taxi Services?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-teal-500 border border-teal-400 rounded-lg p-6 shadow-md hover:shadow-teal-400/30 transition duration-300">
              <div className="flex items-center mb-4">
                <DollarSign className="h-8 w-8 text-teal-100 mr-3" />
                <h3 className="text-xl font-semibold text-teal-100">Competitive Prices and Transparent Fares</h3>
              </div>
            ...
            <div className="bg-teal-500 border border-teal-400 rounded-lg p-6 shadow-md hover:shadow-teal-400/30 transition duration-300">
              <div className="flex items-center mb-4">
                <Calendar className="h-8 w-8 text-teal-100 mr-3" />
                <h3 className="text-xl font-semibold text-teal-100">Customizable Packages</h3>
              </div>
            ...
            <div className="bg-teal-500 border border-teal-400 rounded-lg p-6 shadow-md hover:shadow-teal-400/30 transition duration-300">
              <div className="flex items-center mb-4">
                <Users className="h-8 w-8 text-teal-100 mr-3" />
                <h3 className="text-xl font-semibold text-teal-100">Shared Taxi Options</h3>
              </div>
            ...
            <div className="bg-teal-500 border border-teal-400 rounded-lg p-6 shadow-md hover:shadow-teal-400/30 transition duration-300">
              <div className="flex items-center mb-4">
                <User className="h-8 w-8 text-teal-100 mr-3" />
                <h3 className="text-xl font-semibold text-teal-100">Local and Knowledgeable Drivers</h3>
              </div>
            ...
            <div className="bg-teal-500 border border-teal-400 rounded-lg p-6 shadow-md hover:shadow-teal-400/30 transition duration-300">
              <div className="flex items-center mb-4">
                <MapPin className="h-8 w-8 text-teal-100 mr-3" />
                <h3 className="text-xl font-semibold text-teal-100">Convenient Pick-Up and Drop-Off</h3>
              </div>
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-teal-100 mb-12">Explore Himachal Pradesh Affordably with Our Taxi Packages</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {/* Package 1 */}
            <div className="bg-teal-900 rounded-lg overflow-hidden shadow-md hover:shadow-teal-400/30 transition duration-300 border border-teal-400">
              <div className="h-48 bg-cover bg-center" style={{ backgroundImage: "url('/img/blog/blog10.jpg')" }}></div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-teal-100">North Himachal Tour Package (Economy Package)</h3>
                <p className="mb-4">Visit popular destinations like Manali, Rohtang Pass, and Solang Valley at the best rates.</p>
                <div className="flex justify-end">
                  <button className="bg-teal-400 hover:bg-teal-500 text-teal-100 py-2 px-4 rounded-md transition duration-300">
                    View Details
                  </button>
                </div>
              </div>
            ...
            <div className="bg-teal-900 rounded-lg overflow-hidden shadow-md hover:shadow-teal-400/30 transition duration-300 border border-teal-400">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-teal-100">South Himachal Cultural Tour</h3>
            ...
            <div className="bg-teal-900 rounded-lg overflow-hidden shadow-md hover:shadow-teal-400/30 transition duration-300 border border-teal-400">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-teal-100">Airport and Railway Transfers</h3>
            ...
            <div className="bg-teal-900 rounded-lg overflow-hidden shadow-md hover:shadow-teal-400/30 transition duration-300 border border-teal-400">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-teal-100">Hourly Rentals</h3>
      ...
      <div className="bg-teal-900 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-teal-100 mb-12">Tips to Save Money on Your Himachal Pradesh Vacation</h2>
          <div className="max-w-3xl mx-auto">
            <ul className="space-y-4">
              <li className="flex items-start">
                <CheckCircle className="h-6 w-6 text-teal-100 mr-3 mt-1 flex-shrink-0" />
      ...
      {/* Call to Action */}
      <div className="bg-teal-900 text-teal-100 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">With our affordable taxi services, you can experience the magic of Himachal Pradesh without compromising on comfort or convenience. Book your ride today and embark on a memorable journey through the mountains!</p>
           ...
           <p className="text-lg text-teal-100 mb-8 text-center">
            Contact us today to plan your perfect summer getaway!
            <div className="flex justify-center items-center mt-4">
              <a
                href="tel:+918091595344"
                className="flex items-center gap-2 px-6 py-3 bg-teal-500 text-teal-100 font-bold rounded-full shadow-lg hover:bg-teal-600 hover:shadow-xl transition-all duration-300 ease-in-out"
              >
       ...
       {/* Single Share Button */}
       <section className=" mt-8 text-center pb-12">
          <button
            onClick={handleShare}
            className="px-6 py-3 bg-teal-900 text-teal-100 font-bold rounded-lg shadow-lg hover:bg-teal-700 transition"
          >
            📤 Share This Blog
          </button>
        </section>
