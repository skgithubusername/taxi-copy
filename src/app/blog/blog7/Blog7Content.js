...
const Blog7 = () => {
        ...
        if (navigator.share) {
          try {
            await navigator.share({
              ...
              text: "Unleash the Adventurer in You!",
    ...
    return (
        <div className="bg-teal-900 text-teal-100 min-h-screen p-8">
            <div className="max-w-5xl mx-auto">
                <header className="text-center mb-12">
                    <div className="flex items-center justify-center mb-4">
                        {/* <Bike className="text-teal-400 mr-4" size={48} /> */}
                        <h1 className="text-6xl text-white font-extrabold">Xploroo Ride Packages</h1>
                    </div>
                ...
                <div className=" text-white p-8  mb-10">
                    ...
                    <div className="flex justify-center">
                        {/* <button className="bg-black text-teal-400 px-8 py-3 rounded-full font-bold text-xl hover:bg-teal-800 transition duration-300">
                            Book Your Ride Today
                        </button> */}
                    </div>
                </div>
                
                <div className="bg-black bg-opacity-60 p-8 rounded-xl shadow-lg mb-10 border border-teal-500">
                    <h2 className="text-3xl font-bold mb-6 flex items-center">
                        <CheckCircle className="mr-3 text-teal-400" size={24} /> 
                        Package Highlights
                    </h2>
                    <ul className="space-y-4 text-lg">
                        <li className="flex items-start">
                            <IndianRupee className="mt-1 mr-3 text-teal-400" size={20} />
                            <div>
                                <span className="font-bold">Per Day Cost (Without Meals):</span> ₹3,500/-
                            </div>
                        </li>
                        <li className="flex items-start">
                            <Route className="mt-1 mr-3 text-teal-400" size={20} />
                            <div>
                                <span className="font-bold">Customizable Itineraries:</span> Choose from our curated packages or create your own adventure.
                            </div>
                        </li>
                        <li className="flex items-start">
                            <User className="mt-1 mr-3 text-teal-400" size={20} />
                            <div>
                                <span className="font-bold">Solo Traveler Friendly:</span> We cater to solo adventurers, ensuring a safe and thrilling journey.
                            </div>
                        </li>
                        <li className="flex items-start">
                            <Map className="mt-1 mr-3 text-teal-400" size={20} />
                            <div>
                ...
                <div className="text-center mt-12 mb-8">
                    <h2 className="text-4xl font-bold text-teal-400 mb-6">Ready to Ride?</h2>
                    <p className="text-xl mb-8">Grab your helmet, rev up your bike, and join us for an epic ride through Himachal Pradesh.</p>
                    <div className="bg-teal-500 text-black p-8 rounded-xl shadow-lg inline-block">
