 ...
 export const metadata = {
  ...
  description: 'Discover Himachal Pradesh’s hidden treasures beyond the popular destinations! Explore offbeat sites with taxi access for a unique and unforgettable travel experience.    ',
 
 
};
export default function HimachalSecrets() {
