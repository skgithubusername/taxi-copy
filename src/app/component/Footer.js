            ...
            <div className="container mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="mb-4 font-medium text-2xl">Dhanish Taxi Service Goa</p>
                    ...
                    <div>
                        ...
                        <div className="bg-white h-40 w-full rounded-lg overflow-hidden transition-transform duration-300 ease-in-out hover:scale-105">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3898.2557763254387!2d74.01242081482382!3d15.508789489231473!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfdd84d8a5bf1b%3A0x2d2d2b184a3e4c6!2sGoa!5e0!3m2!1sen!2sin!4v1693665881639!5m2!1sen!2sin"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen=""
