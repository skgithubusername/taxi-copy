...
const AboutUs = () => {
  return (
    <div className="bg-gradient-to-b from-pink-50 to-pink-100 py-20">
      <div className="container mx-auto px-4">
        <h1 className="text-pink-800 text-center text-4xl lg:text-5xl font-bold pb-12">
          Welcome to <span className="text-pink-600">Xploroo Taxi</span>
        </h1>
        
        <div className="flex flex-col md:flex-row w-full lg:w-5/6 mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          {/* First Column - Image */}
          <div className="w-full md:w-1/2 relative">
            <div className="absolute top-0 left-0 w-full h-full bg-pink-800 opacity-10"></div>
            <img 
              src="/logo2.png"
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-pink-900 to-transparent p-6">
              <div className="flex items-center justify-center">
                {/* <span className="bg-white text-pink-700 px-4 py-2 rounded-full font-bold text-sm">Since 2020</span> */}
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-8 lg:p-12">
            <div className="border-l-4 border-pink-500 pl-4 mb-8">
              <h2 className="text-3xl lg:text-4xl font-bold text-pink-700">About Us</h2>
              <p className="text-pink-600 font-medium mt-1">Your trusted travel partner in Shimla and beyond!</p>
            </div>
            ...
            <h3 className="text-2xl font-bold text-pink-700 mt-8 mb-6 flex items-center">
              What sets us apart
              <ArrowRight className="ml-2 text-pink-500" size={20} />
            </h3>

            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-pink-100 p-2 rounded-full mr-4 mt-1">
                  <MapPin className="text-pink-700" size={20} />
                </div>
                <div>
                  <h4 className="font-bold text-pink-800">Local Expertise</h4>
              ...
              <div className="flex items-start">
                <div className="bg-pink-100 p-2 rounded-full mr-4 mt-1">
                  <PhoneCall className="text-pink-700" size={20} />
                </div>
                <div>
                  <h4 className="font-bold text-pink-800">Wide Coverage</h4>
              ...
              <div className="flex items-start">
                <div className="bg-pink-100 p-2 rounded-full mr-4 mt-1">
                  <Shield className="text-pink-700" size={20} />
                </div>
                <div>
                  <h4 className="font-bold text-pink-800">Competitive Pricing</h4>
            ...
            <div className="mt-8 pt-6 border-t border-pink-100">
              <p className="text-pink-800 font-bold text-lg text-center">
                Choose Xploroo Taxi for a hassle-free travel experience!
              </p>
