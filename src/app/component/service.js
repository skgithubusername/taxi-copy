...
const services = [
    { id: 1, image: '/img/services/one.svg', title: 'Tour Packages', description: 'Customized tour packages to explore Goa.' },
    ...
    return (
        <div className='bg-secondary py-20' id='service'>
            <div className='w-11/12 md:w-10/12 mx-auto'>
                ...
                <p className='text-xl md:text-2xl font-light text-primary text-center mb-12'>We’re specialized in providing high-quality taxi services in Goa.</p>
