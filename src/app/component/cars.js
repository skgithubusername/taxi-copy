            ...
            <div className='mx-10'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
                    {cars.map(car => (
                        <div
                            key={car.id}
                            className="group relative overflow-hidden rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 bg-white"
                            onClick={() => handleClick(car)}
                        >
                            <img
                                className="w-full h-64 object-cover transition-opacity duration-300 group-hover:opacity-80 cursor-pointer"
                                src={car.image}
                                alt={car.alt}
                            />
