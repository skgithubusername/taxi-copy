...
//     return (
//         <div className="bg-ehite py-10 md:py-20">
    ...
    return (
        ...
        <div className="w-11/12 md:w-10/12 mx-auto">
            ...
            {/* <div className="text-center mb-6 md:mb-9">
                <button
                    onClick={() => setFilter('all')}
                    className={`mx-1 my-3 lg:my-0 md:mx-2 px-3 md:px-4 py-2 border rounded-md border-white text-white ${
                        filter === 'all' ? 'bg-white text-[#008080]' : 'hover:bg-white hover:text-[#008080]'
                    }`}
                >
                    All
                </button>
                <button
                    onClick={() => setFilter('north-Himachal')}
                    className={`mx-1 md:mx-2 px-3 md:px-4 py-2 border rounded-md border-white text-white ${
                        filter === 'north-Himachal' ? 'bg-white text-[#008080]' : 'hover:bg-white hover:text-[#008080]'
                    }`}
                >
                    North Himachal
                </button>
